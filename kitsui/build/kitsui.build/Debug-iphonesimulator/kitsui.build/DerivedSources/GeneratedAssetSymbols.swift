...
extension ImageResource {
    ...
    static let kitLogoD = ImageResource(name: "KITLogoD", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "KITLogoD" asset catalog image.
    static var kitLogoD: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .kitLogoD)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "KITLogoD" asset catalog image.
    static var kitLogoD: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .kitLogoD)
#else
        .init()
